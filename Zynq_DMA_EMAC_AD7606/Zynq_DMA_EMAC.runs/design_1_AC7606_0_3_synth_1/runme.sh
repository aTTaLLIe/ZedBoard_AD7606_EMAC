...
HD_PWD='D:/Zynq_other/Zynq_Projects/Zynq_DMA_EMAC_AD7606/Zynq_DMA_EMAC.runs/design_1_AC7606_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AC7606_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AC7606_0_3.tcl
