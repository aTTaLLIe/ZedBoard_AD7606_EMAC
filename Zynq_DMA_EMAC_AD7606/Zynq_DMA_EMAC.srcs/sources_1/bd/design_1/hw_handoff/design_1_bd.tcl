...
proc create_root_design { parentCell } {
  ...
  set CNVST [ create_bd_port -dir O CNVST ]
  set CS [ create_bd_port -dir O CS ]
  set DB [ create_bd_port -dir I -from 15 -to 0 DB ]
  set FRSTDATA [ create_bd_port -dir I FRSTDATA ]
  set SCLK [ create_bd_port -dir O SCLK ]
  set led_0 [ create_bd_port -dir O led_0 ]

  # Create instance: AC7606_0, and set properties
  set AC7606_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AC7606:1.0 AC7606_0 ]
  ...
  connect_bd_intf_net -intf_net AC7606_0_M00_AXIS [get_bd_intf_pins AC7606_0/M00_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins AC7606_0/S00_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_net -net AC7606_0_CNVST [get_bd_ports CNVST] [get_bd_pins AC7606_0/CNVST]
  connect_bd_net -net AC7606_0_CS [get_bd_ports CS] [get_bd_pins AC7606_0/CS]
  connect_bd_net -net AC7606_0_SCLK [get_bd_ports SCLK] [get_bd_pins AC7606_0/SCLK]
  connect_bd_net -net AC7606_0_led_0 [get_bd_ports led_0] [get_bd_pins AC7606_0/led_0]
  connect_bd_net -net BUSY_1 [get_bd_ports BUSY] [get_bd_pins AC7606_0/BUSY]
  connect_bd_net -net DB_1 [get_bd_ports DB] [get_bd_pins AC7606_0/DB]
  connect_bd_net -net FRSTDATA_1 [get_bd_ports FRSTDATA] [get_bd_pins AC7606_0/FRSTDATA]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AC7606_0/m00_axis_aclk] [get_bd_pins AC7606_0/s00_axis_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AC7606_0/m00_axis_aresetn] [get_bd_pins AC7606_0/s00_axis_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
